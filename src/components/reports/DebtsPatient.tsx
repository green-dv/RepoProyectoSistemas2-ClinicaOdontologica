            ...
            <CardContent>
                ...
                <Grid item xs={6} md={3}>
                    ...
                    <Typography variant="h4" color="info.main">
                        {DebtReportsHandlers.formatCurrency(totals.totalEsperado)}
                    </Typography>
                    <Typography variant="body2" color="text.secondary">
                        Total Esperado
                    </Typography>
            ...
            {loading ? (
                ...
                <Table>
                    ...
                    <TableRow sx={{ backgroundColor: 'primary.main' }}>
                        ...
                        <TableCell sx={{ color: 'white', fontWeight: 'bold' }} align="right">Total Esperado</TableCell>
                    ...
                    {debts.map((debt) => (
                        ...
                        <TableCell align="right" sx={{ color: 'info.main', fontWeight: 'medium' }}>
                            {DebtReportsHandlers.formatCurrency(Number(debt.total_esperado))}
                        </TableCell>
